...
document.addEventListener("DOMContentLoaded", (event) => {
  document.querySelector('#app').innerHTML = `
    <div class="container" id="container">
      <div class="controls">
        <input type="text" id="attackCommand" class="code-font" placeholder="e.g. 5<n/a/d>+4 vs 16 dmg 2d6fi+3bl+1d4" disabled />
        <button id="rollButton" title="Loading dice..." aria-busy="true" disabled>
          Loading dice...
        </button>
        <div class="options">
